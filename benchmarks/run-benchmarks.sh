...
#  mvn jmh:benchmark "-Djmh.prof=perfasm:hotThreshold=0.01" -Djmh.benchmarks=$BENCHMARKS -Djmh.rf=json -Djmh.rff=target/results-$VERSION.json -DgroupId.jandex=$GROUP_ID -Dversion.jandex=1.0.0-dev-SNAPSHOT
