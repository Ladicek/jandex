...
class AnnotationOverlayImpl implements AnnotationOverlay {
    static final CuckooConcurrentMap.KeyOps<Declaration> KEY_OPS = new CuckooConcurrentMap.KeyOps<Declaration>() {
        @Override
    ...
    final CuckooConcurrentMap<Declaration, Collection<AnnotationInstance>> overlay = new CuckooConcurrentMap<>(KEY_OPS);
